...
(function () {
  ...
  var dropZoneImages = window.form.main.querySelectorAll('.drop-zone');
  var avatarZone = dropZoneImages[0];
  var avatarUser = window.form.main.querySelector('.notice__preview img');
  var photoZone = dropZoneImages[1];
  var uploadPhoto = window.form.main.querySelector('.form__photo-container');
